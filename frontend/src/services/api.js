...
export const getEntrepriseCandidatures = (offreId = null) => {
    const params = offreId ? `?offre_id=${offreId}` : '';
    return api.get(`/candidatures/entreprise/mine${params}`);
};
export const acceptCandidature = (id) => api.put(`/candidatures/${id}/accept`);
